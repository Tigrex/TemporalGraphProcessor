...
public class ProcessOptimizedThreading {
	...
	public ProcessOptimizedThreading() {
	}
	...
	public static void main(String[] args) {
		...
		ProcessOptimizedThreading processor = new ProcessOptimizedThreading();

		String fileName = "SyntheticGraph/Scale12_Edges16.csv.temporal.sim";
